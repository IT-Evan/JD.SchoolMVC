...
using JD.SchoolMVC.Data;
using JD.SchoolMVC.Models;

namespace JD.SchoolMVC.Controllers
{
    public class DepartmentsController : Controller
    {
        private readonly JDSchoolMVCContext _context;

        public DepartmentsController(JDSchoolMVCContext context)
        {
            _context = context;
        }
        ...
        {
            var jDSchoolMVCContext = _context.Departments.Include(d => d.Administrator);
            return View(await jDSchoolMVCContext.ToListAsync());
        }
